...
const withFilter = <P extends InjectedComponentProps<T>, T>( WrappedComponent : ComponentType<P>, itemKey : string ) => {
    return class WrapperComponent extends Component<Props<T> & Subtract<P, InjectedComponentProps<T>>, any> {
        state = {
            filterKey: '',
